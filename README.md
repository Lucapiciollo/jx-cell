...
Tutte le callback vengono scatenate anche dagli
eventi programmatici. Per scenari reattivi preferire i **RxJS stream** in `workbook.events.*`.
...
workbook.orderBy(col: number, asc: boolean): void   // alias
...
workbook.getColumnNameFromId(index: number): string   // alias
...
| `--jx-grid-header-padding-x` | `$jx-grid-header-padding-x` | `10px` | Padding orizzontale header |
...
| `--jx-grid-cell-padding-x` | `$jx-grid-cell-padding-x` | `10px` | Padding orizzontale celle |
